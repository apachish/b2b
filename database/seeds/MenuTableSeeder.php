    ...
    public function run()
    {
        ...
        $menu = [
            ...
            [
                ...
                "base_url" => "home.buy-lead",
                "page_url" => "[]",
                "title" => "Buy Leads",
                "meta_data" => json_encode(["type_category" => "buy-lead", "value" => "", "title" => "", "url" => "home\/buy-lead"]),
                "order_menu" => 5,
                "status" => true,
                "locale" => "en",
                "parent_id" => 2,
            ...
            [
                ...
                "base_url" => "members.my-account",
                "page_url" => "[]",
                "title" => "پروفایل",
                "meta_data" => json_encode(["type_lead" => "", "member_link_item" => "my-account"]),
                "order_menu" => 1,
                "status" => true,
                "locale" => "fa",
                "parent_id" => 16,
            ...
            [
                ...
                "base_url" => "",
                "page_url" => null,
                "title" => "PlacementIndia.com لورم ایپسوم",
                "meta_data" => "[]",
                "order_menu" => 0,
                "status" => true,
                "locale" => "fa",
            ...
            [
                ...
                "page_url" => null,
                "title" => "RealEstateIndia.com Real Estate India",
                "meta_data" => "[]",
                "order_menu" => 1,
                "status" => true,
                "locale" => "fa",
            ...
            [
                ...
                "page_url" => null,
                "title" => "TourTravelWorld.com Electronic Goods",
                "meta_data" => "[]",
                "order_menu" => 2,
                "status" => true,
                "locale" => "fa",
            ...
            [
                ...
                "page_url" => null,
                "title" => "MatrimonialsIndia.com Find Soulmate in India",
                "meta_data" => "[]",
                "order_menu" => 3,
                "status" => true,
                "locale" => "fa",
            ...
            [
                ...
                "page_url" => null,
                "title" => "IndiaYellowPages.com Find Buyers & Seller",
                "meta_data" => "[]",
                "order_menu" => 4,
                "status" => true,
                "locale" => "fa",
            ...
            [
                ...
                "page_url" => null,
                "title" => "TradingBiz.com Business in India",
                "meta_data" => "[]",
                "order_menu" => 5,
                "status" => true,
                "locale" => "fa",
