...
class CategoryMenuTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $category = [
            ...
            ['id' => 11, 'title' => 'My Account', 'url' => 'members/my-account', 'status' => true, 'locale' => 'en', 'position' => 'header_1'],
            ...
            ['id' => 21, 'title' => 'حساب کاربری', 'url' => 'members/my-account', 'status' => true, 'locale' => 'fa', 'position' => 'header_1'],
