...
$(".is_english").on("keypress", function (event) {
...
console.log(event.keyCode);
    ...
    if (event.keyCode == 8 || event.keyCode == 37 || event.keyCode == 39 ||event.keyCode == 95 || englishAlphabetAndWhiteSpace.test(key)) {
        return true;
    }
...
$('.is_english').on("paste", function (e) {
    e.preventDefault();
});
