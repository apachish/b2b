                ...
                <div class="row">
                    <div class="col-lg-9 col-sm-12 col-md-9 col-xs-12 divmaincontent">
                        ...
                        <form class="changpass editlead" id="create_lead" enctype="multipart/form-data" method="post"
                              action="{{route('members.leads.post.update',['slug_lead'=>$lead->product_friendly_url])}}">
                            {{csrf_field()}}
                            @method('PATCH')
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="category" id="category" class="selectpicker form-control"
                                            ...
                                            <option {{$parent_parent__id == $category->id ? "selected" : ""}} value="{{$category->id}}">{{$category->getCategoryTitle()}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row" id="div_category2"
                                    ...
                                    <div class="col-sm-9">
                                        <select name="category2" id="category2" class="mt5 form-control"
                                            ...
                                            <option {{ $parent_id == $category->id ? "selected" : ""}}  value="{{$category->id}}" >{{$category->getCategoryTitle()}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row " id="div_category3" style="{{$sub_sub_categories ? "" : "display: none"}}">
                                ...
                                <div class="form-group row short_description">
                                    ...
                                    <div class=" col-sm-9">
                                        <textarea class="inouttyeptext form-control " name="description"
                                                  ...
                                                  title="{{__('messages.productsDescription')}}">{{$lead['description']}}</textarea>
                                        <p class="charlimit"></p>
                                ...
                                <div class="form-group row detail_description">
                                    ...
                                    <div class=" col-sm-9">
                                        <textarea class="inouttyeptext form-control " name="detail_description"
                                                  ...
                                                  title="{{__('messages.detailDescription')}}">{{$lead['detail_description']}}</textarea>
                                        <p class="charlimit"></p>
                                ...
                                <div class="form-group row detail_description">
                                    <label class="col-sm-3 col-form-label"
                                           for="detail_description">{{__('messages.meta Keywords')}} <b
                                                class="red">*</b> :</label>
                                    <div class=" col-sm-6">
                                        <textarea type="text" id="metaKeywords" name="meta_keywords" rows="20"

                                               class="   form-control tagsinput">{{$lead['meta_keywords']}}</textarea>
