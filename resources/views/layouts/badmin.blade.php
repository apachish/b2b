...
<head>
    ...
    <script src="{{ asset('/js/persian-datepicker.js') }}" defer></script>
    <script src="{{ asset('/select2/select2.min.js') }}" defer></script>
    <script src="{{ asset('/js/toastr.js') }}" defer></script>
    <script src="{{ asset('/js/plugins/bootstrap/bootstrap.min.js') }}" defer></script>
    <script src="{{ asset('/js/plugins/jquery/jquery-ui.min.js') }}" defer></script>
    <script src="{{ asset('/js/plugins/jquery/jquery.min.js') }}" defer></script>
    ...
    <link href="{{ asset('/vendor/pnotify/pnotify.custom.min.css') }}" rel="stylesheet">
