...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="#">{{ __("messages.Manage Leads") }}</a></li>
    </ul>
    <!-- END BREADCRUMB -->

    <!-- PAGE TITLE -->
    <div class="page-title">
        <h2><span class="fa fa-arrow-circle-o-left"></span>{{ __("messages.Leads Lists") }}</h2>
    </div>
    <!-- END PAGE TITLE -->
                                    ...
                                    @foreach ($leads as $lead)
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right">
                                                ...
                                                <p>
                                                    {{ __("messages.Ad Type") }}
                                                    : {{$type = $lead['adType'] == '1' ? __("messages.Sell") : __("messages.Buy") }}
                                                </p>
                                                <p>
                                                    <a href="{{ $this->url('company/detail',['id'=>$lead['user']['id']])}}"
                                                       class="btn btn-dark"
                                                       target="_blank">{{$lead['user']['fullName']}}</a>: {{ __("messages.Sender Name") }}
                                                </p>
                                                <p>
                                            ...
                                            <td style="text-align: right">
                                                ...
                                                @if (!empty($lead['categoryName']))
                                                    {{ __("messages.Category") }} : {{ $lead['categoryName'][0]}}
                                            ...
                                            <td>
                                                ...
                                                >
                                                    <option value="1"
                                                            {{ (isset($lead['approvalStatus']) && $lead['approvalStatus'] == 'Pending') ? 'selected' : '' }} >{{ __("messages.Pending") }}</option>
                                                    <option
                                                            value="2" {{ (isset($lead['approvalStatus']) && $lead['approvalStatus'] == 'Approved') ? 'selected' : '' }}>{{ __("messages.Approved") }}</option>
                                                    <option
                                                            value="3" {{ (isset($lead['approvalStatus']) && $lead['approvalStatus'] == 'Rejected') ? 'selected' : '' }}>{{ __("messages.Rejected") }}</option>
                                                </select>
                                            </td>
                                            <td>
                                                ...
                                                >
                                                    <option value="0"
                                                            {{ (isset($lead['status']) && $lead['status'] == 'inactive') ? 'selected' : '' }}>{{ __("messages.Inactive") }}</option>
                                                    <option
                                                            value="1" {{ (isset($lead['status']) && $lead['status'] == 'active') ? 'selected' : '' }}>{{ __("messages.Active") }}</option>
                                                </select></td>
                                            <td>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span
                                    aria-hidden="true">&times;</span><span class="sr-only">{{ __("messages.Close")}}</span>
                        </button>
