...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            <form   action="{{route("pages.update",['id'=>$page->id])}}" id="postForm"  class="form-horizontal"  method="post" enctype="multipart/form-data">

                {{csrf_field()}}
                @method('PATCH')
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>{{__("messages.Edit")}}</strong> {{__("messages.Page")}}</h3>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        <textarea class="form-control" name="short_description" rows="5">{{$page->short_description}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <textarea name="description" id="description" class=" form-control summernote">{!!  $page->description!!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class=" form-group" >
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <a class="image" href="{{asset('images/pages/'.$page->image)}}" title="{{$page->name}}" data-gallery>
                                            <img src="{{asset('images/pages/'.$page->image)}}" alt="{{$page->name}}" width="173px" height="129px"/>
                                        </a>
                                        @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control " name="status">
                                            <option value="0" {{$page->status==0?"selected":""}} >{{__("messages.Unactivated")}}</option>
                                            <option value="1" {{$page->status==1?"selected":""}} >{{__("messages.active")}}</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control " name="language">
                                            <option value="en" {{$page->locale=='en'?"selected":""}}>{{__("messages.en_US")}}</option>
                                            <option value="fa"  {{$page->locale=='fa'?"selected":""}}>{{__("messages.fa_IR")}}</option>
                                        </select>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
