                        ...
                        'columnDefs': [
                            {
                                ...
                                render: function (data, type, row) {
                                    return '<a type="button" class=" mb-control details" data-details="message-box-info-details" ' +
                                        'data-url="/admin/pages/' + row.id + '"/show' +
                                        'data-box="#message-box-info-details">{{__('messages.View Details')}}</a>';
                                },
                                className: "dt-body-center",
                                orderable: false,
                                ...
                                render: function (data, type, row) {
                                    ...
                                    return '<select class="form-control status" name="status" data-url="pages/status/change/' + row.id + '" ' +
                                        'id="status_' + row.id + '">' +
                                ...
                                render: function (data, type, row) {
                                    ...
                                    return '<a href="/admin/pages/' + row.id + '/edit">' +
                                        ...
                                        '<a class="delete" href="#" data-id="' + row.id + '">' +
