...
<ul class="breadcrumb">
    ...
    <li class="active"><a href="#">{{ __("messages.Edit Category") }}</a></li>
</ul>
<!-- END BREADCRUMB -->
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <strong>{{ __("messages.Edit") }}</strong> {{ __("messages.Category") }}</h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control " name="status">
                                            <option value="0" {{$category->status == 0 ? 'selected' : '' }}>{{ __("messages.Unactivated") }}</option>
